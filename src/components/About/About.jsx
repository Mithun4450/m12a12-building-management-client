    ...
    return (
        <div className="my-14">
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center lg:gap-5">
                ...
                <div className="w-3/4 lg:w-1/2 ">
                    <p className="text-justify">Accord Palace stands as an architectural marvel, an embodiment of contemporary elegance nestled in a vibrant neighborhood. Boasting a collection of modern, thoughtfully designed apartments, it offers an unparalleled living experience. Each unit is a sanctuary of comfort and style, crafted with meticulous attention to detail. <br /> 
                    ...
                    Accord Palace prides itself on more than just lavish interiors; it fosters a community-oriented environment. Residents enjoy access to exclusive amenities, including a fitness center, communal lounges, and meticulously landscaped outdoor spaces perfect for social gatherings or quiet contemplation. <br /> 

                    Conveniently located near bustling entertainment hubs and transportation, Accord Palace offers the epitome of urban living fused with tranquility—a place where tenants can savor both the vibrancy of the city and the comforts of home.</p>
                </div>
            </div>
